...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/*
    nestedFunction can access the variable "internal" because it is within the scope of the function. "internal" and "nestedFunction" are both inside of "myFunction", which means they share the same scope.
*/
...
const zooAnimals = [
 ...
 // parameter: array of Animals; returns: array of strings
  ...
  */
  ...
  // argument: array of objects; returns: array of objects
  ...
  */
  ...
  // argument: array of objects; returns: int
  ...
  */
    ...
    // arguments: anything, anything, function; returns invocation of callback
...
// arguments: string, string; returns: string
